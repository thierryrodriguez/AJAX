...
class Personas_Model extends Conexion
{
    ...
    public static function Listar_Personas_Ajax()
    {
        ...
        try {
            $con = new Conexion();
            $consulta = "SELECT id_persona, cedula, primer_nombre, segundo_nombre, 
            primer_apellido, segundo_apellido, fecha_nac FROM persona";
            $resultado
                = $con->query($consulta)->fetchAll(PDO::FETCH_ASSOC);
        } catch (Exception $e) {
            throw new Exception($e->getMessage());
        }
        return $resultado;
    }
    public static function Listar_Personas_Por_Cedula_Ajax($id_persona)
    {
        $resultado = null;
        try {
